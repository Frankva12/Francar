...
const apiAccount = '../../core/api/public/usuarios.php?site=public&action=';
const apiLibros2 = '../../core/api/public/libros.php?site=public&action=';
    ...
    $.ajax({
        ...
        .done(function (response) {
            ...
            if (isJSONString(response)) {
                ...
                if (result.status) {
                    $('#profile_nombres').val(result.dataset.nombre_cliente);
                    $('#profile_apellidos').val(result.dataset.apellido_cliente);
                    $('#profile_correo').val(result.dataset.correo);
                    $('#profile_alias').val(result.dataset.alias_cliente);
                    M.updateTextFields();
        ...
        .done(function (response) {
            ...
            if (isJSONString(response)) {
                ...
                if (result.status) {
                    ...
                    sweetAlert(1, 'Perfil modificado correctamente/Profile modify correctly', 'index.php');
                } else {
                    sweetAlert(2, result.exception, null);
                }
            } else {
        ...
        .done(function (response) {
            ...
            if (isJSONString(response)) {
                ...
                if (result.status) {
                    ...
                    sweetAlert(1, 'Contraseña cambiada correctamente/Password changed correctly', 'index.php');
                } else {
                    sweetAlert(2, result.exception, null);
                }
            } else {
